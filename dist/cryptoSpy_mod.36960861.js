...
var _authControllerJs = require("./controllers/auth/authController.js");
var _authViewJs = require("./views/authView.js");
var _mobileControllerJs = require("./controllers/menu/mobileController/mobileController.js");
var _menuViewJs = require("./views/menuView.js");
var _iconControllerJs = require("./controllers/spriteSVGController/iconController.js");
var _themeManagerJs = require("./models/ui/themeManager.js");
var _fontsMobileViewJs = require("./views/menuDevices/fontsMobileView.js");
var _greetingControllerJs = require("./controllers/home/greetingController.js");
var _sessionControllerJs = require("./controllers/session/sessionController.js");
var _sessionControllerJsDefault = parcelHelpers.interopDefault(_sessionControllerJs);
var _portfolioControllerJs = require("./controllers/home/portfolioController.js");
var _marketModelJs = require("./models/market/marketModel.js");
var _marketModelJsDefault = parcelHelpers.interopDefault(_marketModelJs);
var _marketControllerJs = require("./controllers/home/market/marketController.js");
var _viewMoreControllerJs = require("./controllers/home/market/viewMoreController.js");
var _addHoldingsControllerJs = require("./controllers/home/market/addHoldingsController.js");
const marketModel = new (0, _marketModelJsDefault.default)();
document.addEventListener('DOMContentLoaded', async ()=>{
    try {
        (0, _authViewJs.loaderEl).classList.remove('hidden');
        (0, _sessionControllerJsDefault.default).init();
        (0, _addHoldingsControllerJs.addHoldings).injectTemplatetoPanel();
        (0, _addHoldingsControllerJs.addHoldings).init();
        (0, _iconControllerJs.loadSVGSprite)();
        (0, _themeManagerJs.themeManager).init();
        (0, _fontsMobileViewJs.fontActionsObj).init();
        _authControllerJs.initAuthToggle();
        _authControllerJs.initTogglePasswordVisibility();
        _authControllerJs.handleLoginValidation();
        _authControllerJs.handleSignupValidation();
        (0, _greetingControllerJs.greetingControllerObj).initGreetingUi();
        (0, _portfolioControllerJs.portfolioController).initPortfolioSummary();
        await (0, _marketControllerJs.marketController).init();
        await (0, _viewMoreControllerJs.viewMoreController).init();
        (0, _menuViewJs.initMenuButtons)();
        _mobileControllerJs.initMenuController();
        _mobileControllerJs.init();
    } catch (err) {
        console.error('App initialization failed:', err);
    } finally{
        (0, _authViewJs.loaderEl).classList.add('hidden');
    }
});

},{"./controllers/auth/authController.js":"8qRXf","./views/authView.js":"94HPK","./controllers/menu/mobileController/mobileController.js":"eZ3oK","./views/menuView.js":"fwEsz","./controllers/spriteSVGController/iconController.js":"8oAPi","./models/ui/themeManager.js":"gw0Lo","./views/menuDevices/fontsMobileView.js":"bE6AW","./controllers/home/greetingController.js":"dAtzM","./controllers/session/sessionController.js":"5AgXN","./controllers/home/portfolioController.js":"kaXqB","./models/market/marketModel.js":"3NpTX","./controllers/home/market/marketController.js":"6CZOb","./controllers/home/market/viewMoreController.js":"eXOdo","./controllers/home/market/addHoldingsController.js":"9hkbW","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"8qRXf":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initAuthToggle", ()=>initAuthToggle);
parcelHelpers.export(exports, "initTogglePasswordVisibility", ()=>initTogglePasswordVisibility);
parcelHelpers.export(exports, "handleLoginValidation", ()=>handleLoginValidation);
parcelHelpers.export(exports, "handleSignupValidation", ()=>handleSignupValidation);
var _authViewJs = require("../../views/authView.js");
var _authModelJs = require("../../models/auth/authModel.js");
var _formValidatorJs = require("../../helpers/formValidator.js");
var _mobileControllerJs = require("../menu/mobileController/mobileController.js");
var _greetingControllerJs = require("../home/greetingController.js");
var _viewManagerJs = require("../viewManager/viewManager.js");
const { loginForm, signupForm, textCenter, toggleSignupBtn, toggleLoginBtn, passwordInputFields, toggleEyeBtns, loaderEl, clearLoginErrors, clearSignupErrors, loginFieldElements, signupFieldElements, getLoginFormData, getSignupFormData } = _authViewJs;
const { registerUser, loginUser } = _authModelJs;
const { isValidName, isValidEmail, isValidPassword, validateInputField } = _formValidatorJs;
...
const changeAuthView = (e)=>{
    ...
    // Change header text
    textCenter.textContent = signupstate ? 'Create an account' : 'Login to your account';
...
function initTogglePasswordVisibility() {
    toggleEyeBtns.forEach((eyeBtn, index)=>{
        eyeBtn.addEventListener('click', ()=>{
            ...
            inputFieldClicked.type = inputFieldClicked.type === 'password' ? 'text' : 'password';
            if (currentIcon === '#icon-eye-closed') useTag.setAttribute('xlink:href', '#icon-eye-open');
            else useTag.setAttribute('xlink:href', '#icon-eye-closed');
        });
    });
}
function handleLoginValidation() {
    ...
    loginForm.addEventListener('submit', async (e)=>{
        ...
        // Email input field
        const emailValid = validateInputField(emailInputEl, isValidEmail, emailErrContainerEl, emailErrTextEl, 'Please enter a valid email');
        // Password input field
        const passwordValid = validateInputField(passwordInputEl, isValidPassword, passwordErrContainerEl, passwordErrTextEl, 'Minimum 6 chars, letters & numbers');
        if (emailValid && passwordValid) try {
            ...
            form.reset();
            (0, _viewManagerJs.viewManager).hideAndShowRest('auth-section', 'dashboard-section', 'dashboard-header');
        } catch (error) {
            const formattedError = error.code ? error.code.replace('auth/', '').replace('-', ' ') : error.message;
            // Handle error
...
function handleSignupValidation() {
    ...
    const confirmPasswordErrContainerEl = confirmPasswordElements_obj.errorContainer;
    ...
    signupForm.addEventListener('submit', async (e)=>{
        ...
        // Name validate
        const nameValid = validateInputField(nameInputEl, isValidName, nameErrContainerEl, nameErrTextEl, 'Only 2-30 letters allowed');
        // Email validate
        const emailValid = validateInputField(emailInputEl, isValidEmail, emailErrContainerEl, emailErrTextEl, 'Please enter a valid email');
        // Password validate
        const passwordValid = validateInputField(passwordInputEl, isValidPassword, passwordErrContainerEl, passwordErrTextEl, 'Min 4 chars, letters & numbers');
        ...
        } else confirmPasswordErrContainerEl.classList.add('hidden');
        if (nameValid && emailValid && passwordValid && confirmPasswordValid) try {
            loaderEl.classList.remove('hidden'); // Show spinner
            // Ensures the username is rendered before the async fetches username
            (0, _greetingControllerJs.greetingControllerObj).initGreetingUi();
            const user = await registerUser(signupName, signupEmail, signupPassword);
            (0, _mobileControllerJs.updateUserInfo)(user); // Pass the signed in user to this method for menu
            changeAuthView();
            (0, _viewManagerJs.viewManager).hideAndShowRest('auth-section', 'dashboard-section', 'dashboard-header');
            form.reset(); // Clear form inputs
        } catch (error) {
            const formattedError = error.code ? error.code.replace('auth/', '').replace(/-/g, ' ') : error.message;
            emailErrContainerEl.classList.remove('hidden');
            emailErrTextEl.textContent = formattedError;
        } finally{
...
},{"../../views/authView.js":"94HPK","../../models/auth/authModel.js":"9UXRz","../../helpers/formValidator.js":"6gIop","../menu/mobileController/mobileController.js":"eZ3oK","../home/greetingController.js":"dAtzM","../viewManager/viewManager.js":"3PeSj","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"94HPK":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "loginForm", ()=>loginForm);
parcelHelpers.export(exports, "signupForm", ()=>signupForm);
parcelHelpers.export(exports, "toggleSignupBtn", ()=>toggleSignupBtn);
parcelHelpers.export(exports, "toggleLoginBtn", ()=>toggleLoginBtn);
parcelHelpers.export(exports, "textCenter", ()=>textCenter);
parcelHelpers.export(exports, "loaderEl", ()=>loaderEl);
parcelHelpers.export(exports, "authSectionEl", ()=>authSectionEl);
parcelHelpers.export(exports, "dashboardSectionEl", ()=>dashboardSectionEl);
parcelHelpers.export(exports, "usernameEl", ()=>usernameEl);
parcelHelpers.export(exports, "userEmailEl", ()=>userEmailEl);
parcelHelpers.export(exports, "userID", ()=>userID);
parcelHelpers.export(exports, "logoutBtnEl", ()=>logoutBtnEl);
parcelHelpers.export(exports, "passwordInputFields", ()=>passwordInputFields);
parcelHelpers.export(exports, "toggleEyeBtns", ()=>toggleEyeBtns);
// For login Validation (incl. error notifier)
parcelHelpers.export(exports, "loginFieldElements", ()=>loginFieldElements);
parcelHelpers.export(exports, "clearLoginErrors", ()=>clearLoginErrors);
parcelHelpers.export(exports, "clearSignupErrors", ()=>clearSignupErrors);
// For signup validation (incl. error notifier)
parcelHelpers.export(exports, "signupFieldElements", ()=>signupFieldElements);
// Get login form data
parcelHelpers.export(exports, "getLoginFormData", ()=>getLoginFormData);
// Get sign-up form data
parcelHelpers.export(exports, "getSignupFormData", ()=>getSignupFormData);
const loginForm = document.getElementById("login-form");
const signupForm = document.getElementById("signup-form");
const toggleSignupBtn = document.getElementById("toggle-signup");
const toggleLoginBtn = document.getElementById("toggle-login");
const textCenter = document.getElementById("dynamic-center-text");
...
const passwordInputFields = document.querySelectorAll(".password-input");
const toggleEyeBtns = document.querySelectorAll(".toggle-password-btn");
function loginFieldElements(fieldName) {
    return {
...
function signupFieldElements(fieldname) {
    return {
...
function getLoginFormData() {
    return {
        loginEmail: document.getElementById("login-email-input").value.trim().toLowerCase(),
        loginPassword: document.getElementById("login-password-input").value.trim().toLowerCase()
    };
}
function getSignupFormData() {
    return {
        signupName: document.getElementById("signup-name-input").value.trim().toLowerCase(),
        signupEmail: document.getElementById("signup-email-input").value.trim().toLowerCase(),
        signupPassword: document.getElementById("signup-password-input").value.trim().toLowerCase()
    };
}
...
},{}],"9UXRz":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Sign up
...
parcelHelpers.export(exports, "observeUser", ()=>observeUser);
// Logout user
parcelHelpers.export(exports, "logoutUser", ()=>logoutUser) // import { auth } from '../../firebase/firebaseInit.js';
 // import {
 ...
 // }
;
var _firebaseInitJs = require("../../firebase/firebaseInit.js");
async function registerUser(name, email, password) {
    ...
    try {
        // 1.  create user
        const userCrediental = await (0, _firebaseInitJs.createUserWithEmailAndPassword)((0, _firebaseInitJs.auth), email, password);
        const user = userCrediental.user;
        // 2. Update profile with displayName
        await (0, _firebaseInitJs.updateProfile)(user, {
            displayName: name
        });
        // 3.Reload the user so the new displayName is available imediately
        await user.reload();
        // 4. Return clean user data (not touching the view)
        return (0, _firebaseInitJs.auth).currentUser;
    } catch (error) {
        throw error;
    }
}
async function loginUser(email, password) {
    try {
        return await (0, _firebaseInitJs.signInWithEmailAndPassword)((0, _firebaseInitJs.auth), email, password);
    } catch (error) {
        throw error;
    }
}
function observeUser(callback) {
    (0, _firebaseInitJs.onAuthStateChanged)((0, _firebaseInitJs.auth), (user)=>{
        callback(user || null);
    });
}
async function logoutUser() {
    try {
        return (0, _firebaseInitJs.signOut)((0, _firebaseInitJs.auth));
    } catch (error) {
        throw error;
    }
}

},{"../../firebase/firebaseInit.js":"g79KQ","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"g79KQ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "auth", ()=>auth) // import { initializeApp } from 'https://www.gstatic.com/firebasejs/12.1.0/firebase-app.js';
 // import {
 //   getAuth,
 //   createUserWithEmailAndPassword,
 //   signInWithEmailAndPassword,
...
parcelHelpers.export(exports, "updateProfile", ()=>(0, _auth.updateProfile));
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ActionCodeOperation", ()=>(0, _index1970027FJs.A));
parcelHelpers.export(exports, "ActionCodeURL", ()=>(0, _index1970027FJs.aj));
parcelHelpers.export(exports, "AuthCredential", ()=>(0, _index1970027FJs.M));
parcelHelpers.export(exports, "AuthErrorCodes", ()=>(0, _index1970027FJs.J));
parcelHelpers.export(exports, "EmailAuthCredential", ()=>(0, _index1970027FJs.N));
parcelHelpers.export(exports, "EmailAuthProvider", ()=>(0, _index1970027FJs.W));
parcelHelpers.export(exports, "FacebookAuthProvider", ()=>(0, _index1970027FJs.X));
parcelHelpers.export(exports, "FactorId", ()=>(0, _index1970027FJs.F));
parcelHelpers.export(exports, "GithubAuthProvider", ()=>(0, _index1970027FJs.Z));
parcelHelpers.export(exports, "GoogleAuthProvider", ()=>(0, _index1970027FJs.Y));
parcelHelpers.export(exports, "OAuthCredential", ()=>(0, _index1970027FJs.Q));
parcelHelpers.export(exports, "OAuthProvider", ()=>(0, _index1970027FJs._));
parcelHelpers.export(exports, "OperationType", ()=>(0, _index1970027FJs.O));
parcelHelpers.export(exports, "PhoneAuthCredential", ()=>(0, _index1970027FJs.U));
parcelHelpers.export(exports, "PhoneAuthProvider", ()=>(0, _index1970027FJs.P));
parcelHelpers.export(exports, "PhoneMultiFactorGenerator", ()=>(0, _index1970027FJs.n));
parcelHelpers.export(exports, "ProviderId", ()=>(0, _index1970027FJs.q));
parcelHelpers.export(exports, "RecaptchaVerifier", ()=>(0, _index1970027FJs.R));
parcelHelpers.export(exports, "SAMLAuthProvider", ()=>(0, _index1970027FJs.$));
parcelHelpers.export(exports, "SignInMethod", ()=>(0, _index1970027FJs.S));
parcelHelpers.export(exports, "TotpMultiFactorGenerator", ()=>(0, _index1970027FJs.T));
parcelHelpers.export(exports, "TotpSecret", ()=>(0, _index1970027FJs.o));
parcelHelpers.export(exports, "TwitterAuthProvider", ()=>(0, _index1970027FJs.a0));
parcelHelpers.export(exports, "applyActionCode", ()=>(0, _index1970027FJs.a8));
parcelHelpers.export(exports, "beforeAuthStateChanged", ()=>(0, _index1970027FJs.y));
parcelHelpers.export(exports, "browserCookiePersistence", ()=>(0, _index1970027FJs.a));
parcelHelpers.export(exports, "browserLocalPersistence", ()=>(0, _index1970027FJs.b));
parcelHelpers.export(exports, "browserPopupRedirectResolver", ()=>(0, _index1970027FJs.m));
parcelHelpers.export(exports, "browserSessionPersistence", ()=>(0, _index1970027FJs.c));
parcelHelpers.export(exports, "checkActionCode", ()=>(0, _index1970027FJs.a9));
parcelHelpers.export(exports, "confirmPasswordReset", ()=>(0, _index1970027FJs.a7));
parcelHelpers.export(exports, "connectAuthEmulator", ()=>(0, _index1970027FJs.L));
parcelHelpers.export(exports, "createUserWithEmailAndPassword", ()=>(0, _index1970027FJs.ab));
parcelHelpers.export(exports, "debugErrorMap", ()=>(0, _index1970027FJs.H));
parcelHelpers.export(exports, "deleteUser", ()=>(0, _index1970027FJs.G));
parcelHelpers.export(exports, "fetchSignInMethodsForEmail", ()=>(0, _index1970027FJs.ag));
parcelHelpers.export(exports, "getAdditionalUserInfo", ()=>(0, _index1970027FJs.ar));
parcelHelpers.export(exports, "getAuth", ()=>(0, _index1970027FJs.p));
parcelHelpers.export(exports, "getIdToken", ()=>(0, _index1970027FJs.ao));
parcelHelpers.export(exports, "getIdTokenResult", ()=>(0, _index1970027FJs.ap));
parcelHelpers.export(exports, "getMultiFactorResolver", ()=>(0, _index1970027FJs.at));
parcelHelpers.export(exports, "getRedirectResult", ()=>(0, _index1970027FJs.k));
parcelHelpers.export(exports, "inMemoryPersistence", ()=>(0, _index1970027FJs.V));
parcelHelpers.export(exports, "indexedDBLocalPersistence", ()=>(0, _index1970027FJs.i));
parcelHelpers.export(exports, "initializeAuth", ()=>(0, _index1970027FJs.K));
parcelHelpers.export(exports, "initializeRecaptchaConfig", ()=>(0, _index1970027FJs.v));
parcelHelpers.export(exports, "isSignInWithEmailLink", ()=>(0, _index1970027FJs.ae));
parcelHelpers.export(exports, "linkWithCredential", ()=>(0, _index1970027FJs.a3));
parcelHelpers.export(exports, "linkWithPhoneNumber", ()=>(0, _index1970027FJs.l));
parcelHelpers.export(exports, "linkWithPopup", ()=>(0, _index1970027FJs.e));
parcelHelpers.export(exports, "linkWithRedirect", ()=>(0, _index1970027FJs.h));
parcelHelpers.export(exports, "multiFactor", ()=>(0, _index1970027FJs.au));
parcelHelpers.export(exports, "onAuthStateChanged", ()=>(0, _index1970027FJs.z));
parcelHelpers.export(exports, "onIdTokenChanged", ()=>(0, _index1970027FJs.x));
parcelHelpers.export(exports, "parseActionCodeURL", ()=>(0, _index1970027FJs.ak));
parcelHelpers.export(exports, "prodErrorMap", ()=>(0, _index1970027FJs.I));
parcelHelpers.export(exports, "reauthenticateWithCredential", ()=>(0, _index1970027FJs.a4));
parcelHelpers.export(exports, "reauthenticateWithPhoneNumber", ()=>(0, _index1970027FJs.r));
parcelHelpers.export(exports, "reauthenticateWithPopup", ()=>(0, _index1970027FJs.f));
parcelHelpers.export(exports, "reauthenticateWithRedirect", ()=>(0, _index1970027FJs.j));
parcelHelpers.export(exports, "reload", ()=>(0, _index1970027FJs.as));
parcelHelpers.export(exports, "revokeAccessToken", ()=>(0, _index1970027FJs.E));
parcelHelpers.export(exports, "sendEmailVerification", ()=>(0, _index1970027FJs.ah));
parcelHelpers.export(exports, "sendPasswordResetEmail", ()=>(0, _index1970027FJs.a6));
parcelHelpers.export(exports, "sendSignInLinkToEmail", ()=>(0, _index1970027FJs.ad));
parcelHelpers.export(exports, "setPersistence", ()=>(0, _index1970027FJs.t));
parcelHelpers.export(exports, "signInAnonymously", ()=>(0, _index1970027FJs.a1));
parcelHelpers.export(exports, "signInWithCredential", ()=>(0, _index1970027FJs.a2));
parcelHelpers.export(exports, "signInWithCustomToken", ()=>(0, _index1970027FJs.a5));
parcelHelpers.export(exports, "signInWithEmailAndPassword", ()=>(0, _index1970027FJs.ac));
parcelHelpers.export(exports, "signInWithEmailLink", ()=>(0, _index1970027FJs.af));
parcelHelpers.export(exports, "signInWithPhoneNumber", ()=>(0, _index1970027FJs.s));
parcelHelpers.export(exports, "signInWithPopup", ()=>(0, _index1970027FJs.d));
parcelHelpers.export(exports, "signInWithRedirect", ()=>(0, _index1970027FJs.g));
parcelHelpers.export(exports, "signOut", ()=>(0, _index1970027FJs.D));
parcelHelpers.export(exports, "unlink", ()=>(0, _index1970027FJs.aq));
parcelHelpers.export(exports, "updateCurrentUser", ()=>(0, _index1970027FJs.C));
parcelHelpers.export(exports, "updateEmail", ()=>(0, _index1970027FJs.am));
parcelHelpers.export(exports, "updatePassword", ()=>(0, _index1970027FJs.an));
parcelHelpers.export(exports, "updatePhoneNumber", ()=>(0, _index1970027FJs.u));
parcelHelpers.export(exports, "updateProfile", ()=>(0, _index1970027FJs.al));
parcelHelpers.export(exports, "useDeviceLanguage", ()=>(0, _index1970027FJs.B));
parcelHelpers.export(exports, "validatePassword", ()=>(0, _index1970027FJs.w));
parcelHelpers.export(exports, "verifyBeforeUpdateEmail", ()=>(0, _index1970027FJs.ai));
parcelHelpers.export(exports, "verifyPasswordResetCode", ()=>(0, _index1970027FJs.aa));
var _index1970027FJs = require("./index-1970027f.js");
var _app = require("@firebase/app");
var _util = require("@firebase/util");
var _logger = require("@firebase/logger");
var _component = require("@firebase/component");

},{"./index-1970027f.js":"2rxpv","@firebase/app":"clWgn","@firebase/util":"jy04l","@firebase/logger":"9cikG","@firebase/component":"d6O5O","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"2rxpv":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@firebase/app":"clWgn","@firebase/util":"jy04l","@firebase/logger":"9cikG","@firebase/component":"d6O5O","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"6gIop":[function(require,module,exports,__globalThis) {
...
parcelHelpers.export(exports, "isValidPassword", ()=>isValidPassword);
parcelHelpers.export(exports, "validateInputField", ()=>validateInputField);
...
function validateInputField(inputEl, isValidFnc, errorBoxEl, errorTextEl, errorMsg) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"eZ3oK":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// --------------------------
...
parcelHelpers.export(exports, "initMenuController", ()=>initMenuController);
parcelHelpers.export(exports, "init", ()=>init);
var _menuViewJs = require("../../../views/menuView.js");
var _domHelpersJs = require("../../../helpers/domHelpers.js");
var _modeThemeMediumViewJs = require("../../../views/menuDevices/modeThemeMediumView.js");
var _fontsMediumViewJs = require("../../../views/menuDevices/fontsMediumView.js");
var _mobileMenuControllerJs = require("../mobileMenuController.js");
var _mobileMenuControllerJsDefault = parcelHelpers.interopDefault(_mobileMenuControllerJs);
var _mediumMenuControllerJs = require("../mediumMenuController.js");
var _mediumMenuControllerJsDefault = parcelHelpers.interopDefault(_mediumMenuControllerJs);
var _largeMenuControllerJs = require("../largeMenuController.js");
var _largeMenuControllerJsDefault = parcelHelpers.interopDefault(_largeMenuControllerJs);
var _authViewJs = require("../../../views/authView.js");
var _menuPublisherJs = require("../../publisher/menuPublisher.js");
var _pubsubJs = require("../../../helpers/pubsub.js");
var _authModelJs = require("../../../models/auth/authModel.js");
// ------------------------------------------------
...
function updateUserInfo(user) {
    const { userNameEls, userEmailEls, userIdEls } = _menuViewJs.getUserInfoElements();
    if (!user) {
    ...
    const formattedName = displayName[0].toUpperCase() + displayName.slice(1).toLowerCase();
    ...
    userIdEls.forEach((userIdEl)=>userIdEl.textContent = "ID: " + slicedUserID.toLowerCase() + '***');
}
function renderMenusForUser(user) {
    if (user) updateUserInfo(user);
    else {
        _menuViewJs.onLogoutObj.forScreen('mobile');
        _menuViewJs.onLogoutObj.forScreen('medium');
        updateUserInfo(null);
    }
    _domHelpersJs.hideAllSections((0, _authViewJs.loaderEl));
}
function initMenuController() {
    ...
    screens.forEach((screen)=>_menuViewJs.renderMenu(screen));
    (0, _authModelJs.observeUser)(renderMenusForUser);
    (0, _pubsubJs.subscribe)('menu:open', ({ screen })=>{
        _menuViewJs.showMenu(screen); // Hamburger menu control
        if (screen === 'medium') {
            (0, _modeThemeMediumViewJs.modeAndThemeMediumViewObj).resetAccordion();
            (0, _fontsMediumViewJs.fontsMediumActionsObj).resetAccordion();
        }
    });
    new (0, _mobileMenuControllerJsDefault.default)();
    new (0, _mediumMenuControllerJsDefault.default)();
    new (0, _largeMenuControllerJsDefault.default)();
}
function init() {
    (0, _menuPublisherJs.mainMenuObj).addHandlerClick();
    (0, _menuPublisherJs.settingsMenuObj).addHandlerClick();
    (0, _menuPublisherJs.mediumMenuObj).addHandlerClick();
    (0, _menuPublisherJs.modeAndThemeMenuObj).addHandlerClick();
    (0, _menuPublisherJs.fontsMenuObj).addHandlerClick();
    (0, _menuPublisherJs.navMenuObj).addHandlerClick();
}

},{"../../../views/menuView.js":"fwEsz","../../../helpers/domHelpers.js":"fi18D","../../../views/menuDevices/modeThemeMediumView.js":"jNDze","../../../views/menuDevices/fontsMediumView.js":"jUbWb","../mobileMenuController.js":"es57R","../mediumMenuController.js":"bXCZQ","../largeMenuController.js":"bxbaK","../../../views/authView.js":"94HPK","../../publisher/menuPublisher.js":"ldxVE","../../../helpers/pubsub.js":"8Qnew","../../../models/auth/authModel.js":"9UXRz","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"fwEsz":[function(require,module,exports,__globalThis) {
// menuController.js (refactor — preserves original API names)
// ---------------------------------------------------------------------
// Imports (unchanged)
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "menuToggleBtns", ()=>menuToggleBtns);
parcelHelpers.export(exports, "menuElements", ()=>menuElements);
parcelHelpers.export(exports, "templates", ()=>templates);
// ---------------------------------------------------------------------
parcelHelpers.export(exports, "getUserInfoElements", ()=>getUserInfoElements);
// ---------------------------------------------------------------------
parcelHelpers.export(exports, "renderMenu", ()=>renderMenu);
// ---------------------------------------------------------------------
// initMenuButtons: attach event handlers
parcelHelpers.export(exports, "initMenuButtons", ()=>initMenuButtons);
// ---------------------------------------------------------------------
parcelHelpers.export(exports, "showMenu", ()=>showMenu);
parcelHelpers.export(exports, "menuActionsObj", ()=>menuActionsObj);
parcelHelpers.export(exports, "onLogoutObj", ()=>onLogoutObj);
var _templateHelperJs = require("../helpers/templateHelper.js");
var _authViewJs = require("../views/authView.js");
var _modeThemeMediumViewJs = require("./menuDevices/modeThemeMediumView.js");
var _fontsMediumViewJs = require("./menuDevices/fontsMediumView.js");
var _themeManagerJs = require("../models/ui/themeManager.js");
var _fontModelJs = require("../models/ui/fontModel.js");
var _domHelpersJs = require("../helpers/domHelpers.js");
var _pubsubJs = require("../helpers/pubsub.js");
...
const themeManagerObj = new (0, _themeManagerJs.ThemeManager)();
const menuToggleBtns = {
...
function renderMenu(screen) {
    switch(screen){
        case 'mobile':
            if (menuElements.mobile.contentArea && templates.menuItemsTemplate) (0, _templateHelperJs.renderTemplate)(menuElements.mobile.contentArea, templates.menuItemsTemplate);
            break;
        case 'medium':
            if (menuElements.medium.contentArea && templates.menuItemsTemplate) (0, _templateHelperJs.renderTemplate)(menuElements.medium.contentArea, templates.menuItemsTemplate);
            if (menuElements.medium.contentArea && templates.settingsPanelTemplate) (0, _templateHelperJs.renderTemplate)(menuElements.medium.contentArea, templates.settingsPanelTemplate, {
                screen: 'medium'
            });
            break;
        case 'desktop':
            if (menuElements.desktop.navProfileDropdownEl && templates.menuItemsTemplate) (0, _templateHelperJs.renderTemplate)(menuElements.desktop.navProfileDropdownEl, templates.menuItemsTemplate);
            if (menuElements.desktop.navSettingsdropdownEl && templates.settingsPanelTemplate) (0, _templateHelperJs.renderTemplate)(menuElements.desktop.navSettingsdropdownEl, templates.settingsPanelTemplate, {
                screen: 'large'
            });
            break;
        default:
...
function initMenuButtons() {
    ...
    if (menuToggleBtns.mobileToggleBtn) menuToggleBtns.mobileToggleBtn.addEventListener('click', ()=>{
        (0, _pubsubJs.publish)('menu:open', {
            screen: 'mobile'
        });
    });
    if (menuToggleBtns.mediumToggleBtn) menuToggleBtns.mediumToggleBtn.addEventListener('click', ()=>{
        (0, _pubsubJs.publish)('menu:open', {
            screen: 'medium'
        });
    });
    ...
    if (bodyEl) bodyEl.addEventListener('click', (e)=>{
        ...
        if (!isInsideHeader) {
            (0, _pubsubJs.publish)('desktop:bodyEL', {
                screen: 'desktop'
            });
            // console.log('Outside click → closing dropdowns');
            (0, _navViewJs.navViewObj).handleAppReset();
            (0, _navViewJs.navViewObj).closeAllAccordion();
        }
    });
}
function showMenu(screen) {
    ...
    if (screen === 'medium') {
        ...
        const activeThemeEl = document.querySelector('#medium-menu-content #active-theme-name');
        const activeFontEl = document.querySelector('#medium-menu-content #active-font-name');
        if (activeThemeEl) activeThemeEl.textContent = themeManagerObj.getCurrentMode() || '';
        if (activeFontEl) activeFontEl.textContent = (0, _fontModelJs.fontsModel).getFont() || '';
        if (isOpen) {
            // show medium menu
            ...
            if (overlayEl) overlayEl.onclick = ()=>{
                ...
                if ((0, _modeThemeMediumViewJs.modeAndThemeMediumViewObj)?.resetAccordion) (0, _modeThemeMediumViewJs.modeAndThemeMediumViewObj).resetAccordion();
                if ((0, _fontsMediumViewJs.fontsMediumActionsObj)?.resetAccordion) (0, _fontsMediumViewJs.fontsMediumActionsObj).resetAccordion();
            };
        } else {
            // closing state
            aside?.classList.add('invisible');
...
class MenuActions {
    ...
    renderSocials(device) {
        const socialsWrapper = document.querySelector(`#${device}-menu-content #socials-wrapper`);
    ...
    renderSettings() {
        ...
        if (templates.settingsPanelTemplate) (0, _templateHelperJs.renderTemplate)(menuElements.mobileSettings.contentArea, templates.settingsPanelTemplate);
        ...
        setTimeout(()=>{
            menuElements.mobileSettings.contentArea?.classList.toggle('translate-x-full');
        }, 10);
        ...
        const activeThemeEl = document.querySelector('#mobile-settings-content #active-theme-name');
        const activeFontEl = document.querySelector('#mobile-settings-content #active-font-name');
        if (activeThemeEl) activeThemeEl.textContent = currentThemeInUse || 'System';
...
class OnLogout {
    ...
    mediumDevice() {
        ...
        if (isOpen) {
            ...
            menuElements.medium.contentArea?.classList.remove('opacity-100', 'visible');
    ...
    forScreen(screen) {
        if (screen === 'mobile') this.mobileDevice();
        else if (screen === 'medium') this.mediumDevice();
    }
}
const menuActionsObj = new MenuActions();
const onLogoutObj = new OnLogout();

},{"../helpers/templateHelper.js":"l9P0L","../views/authView.js":"94HPK","./menuDevices/modeThemeMediumView.js":"jNDze","./menuDevices/fontsMediumView.js":"jUbWb","../models/ui/themeManager.js":"gw0Lo","../models/ui/fontModel.js":"jegq2","../helpers/domHelpers.js":"fi18D","../helpers/pubsub.js":"8Qnew","./navView.js":"b5nUx","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"l9P0L":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderTemplate", ()=>renderTemplate);
function renderTemplate(targetContainer, templateId, data = {}) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"jNDze":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "modeAndThemeMediumViewObj", ()=>modeAndThemeMediumViewObj);
var _themeManagerJs = require("../../models/ui/themeManager.js");
class ModeAndThemeMediumView {
    constructor(){
        ...
        this.themeManagerObj = new (0, _themeManagerJs.ThemeManager)(); // Shared model (same as mobile)
    }
    ...
    generateModeItemsHTML() {
        ...
        const accordionItemsMarkup = themeMarkupData.map((dataObj)=>this.generateModeMarkup(dataObj)).join('');
    ...
    renderHTML(device) {
        ...
        this.containerEl = document.querySelector(`#settings-wrapper[data-screen="${device}"] #menu-accordion-container`);
        if (!this.containerEl) return;
        if (!this.containerEl.hasChildNodes()) this.containerEl.innerHTML = this.getHTML();
    }
    toggleModeAccordion(device) {
        ...
        allAccordionEl.forEach((accordionEl)=>{
            if (accordionEl !== this.themeAccordionContentEl) {
                ...
                accordionEl.parentElement.querySelector('#font-accordion-arrow').classList.remove('rotate-180');
            }
        });
        if (!this.themeAccordionContentEl.classList.contains('open') && device === 'medium') {
            this.themeAccordionContentEl.style.maxHeight = this.themeAccordionContentEl.scrollHeight + 'px';
            this.themeAccordionContentEl.classList.add('open');
            this.arrowIconEl.classList.add('rotate-180');
        } else this.resetAccordion();
    }
    resetAccordion() {
        if (!this.themeAccordionContentEl) return;
    ...
    positionActiveIndicator(activeMode) {
        ...
        const clickedBtnEl = document.querySelector(`[data-mode = '${activeMode}']`);
        ...
        if (highlightWrapperEL) highlightWrapperEL.innerHTML = this.activeIndicatorTemplate();
    }
    updateActiveTheme(mode) {
        this.activeThemeEl = document.querySelector('#medium-menu-content #active-theme-name');
...
const modeAndThemeMediumViewObj = new ModeAndThemeMediumView();

},{"../../models/ui/themeManager.js":"gw0Lo","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"gw0Lo":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ThemeManager", ()=>ThemeManager);
parcelHelpers.export(exports, "themeManager", ()=>themeManager);
class ThemeManager {
    constructor(){
    ...
    applyTheme(mode) {
        ...
        if (mode === 'system') {
            ...
            prefersDark === true ? this.html.classList.add('dark') : this.html.classList.add('light');
        } else if (mode === 'light') this.html.classList.add('light');
        else if (mode === 'dark') this.html.classList.add('dark');
        else if (mode === 'default') this.html.classList.add('default');
    ...
    setUserTheme(mode) {
        ...
        if (mode === 'system' && !this.systemListenerAdded) this.watchSystemTheme();
    }
    // Listen for system changes
    watchSystemTheme() {
        this.systemListenerAdded = true;
        this.mediaQuery.addEventListener('change', ()=>{
            if (localStorage.getItem('theme') === 'system') this.applyTheme('system'); // Only executes if if condition is true
        });
    }
    getCurrentMode() {
    ...
    init() {
        ...
        } else this.applyTheme(savedTheme); // for light/dark/default
    }
}
const themeManager = new ThemeManager();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"jUbWb":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fontsMediumActionsObj", ()=>fontsMediumActionsObj);
var _menuViewJs = require("../menuView.js");
var _fontsMobileViewJs = require("./fontsMobileView.js");
var _fontModelJs = require("../../models/ui/fontModel.js");
class FontsMediumActions {
    ...
    generateFontOptions({ action, id, value, fontName, title }) {
        const activeFont = (0, _fontsMobileViewJs.fontActionsObj).getCurrentFont();
        const indicator = fontName === activeFont ? this.activeIndicatorTemplate() : '';
        const html = `
      <!-- Font 1 wrapper -->
    ...
    getHTML() {
        ...
        const fontOptionsMarkup = fontMarkupData.map((fontObj)=>this.generateFontOptions(fontObj)).join('');
        return fontOptionsMarkup;
    }
    renderHTML() {
        const { contentArea } = _menuViewJs.menuElements.medium;
        this.contentArea = contentArea;
        this.accordionContentEl = this.contentArea.querySelector('#medium-menu-font-accordion-container');
        if (!this.accordionContentEl.hasChildNodes()) this.accordionContentEl.innerHTML = this.getHTML();
    }
    toggleFontsAccordion() {
        ...
        allAccordionEl.forEach((accordionEl)=>{
            if (accordionEl !== this.fontAccordionContainerEl) {
                accordionEl.style.maxHeight = '0px';
                accordionEl.classList.remove('open');
                accordionEl.parentElement.querySelector('#theme-accordion-arrow').classList.remove('rotate-180');
            }
        });
        if (!this.fontAccordionContainerEl.classList.contains('open')) {
            this.fontAccordionContainerEl.style.maxHeight = this.fontAccordionContainerEl.scrollHeight + 'px';
    ...
    activateIndicator(fontName) {
        document.getElementById(`${fontName}-highlight-wrapper`).innerHTML = this.activeIndicatorTemplate();
    }
    updateActiveTheme(fontName) {
        this.activeThemeEl = document.querySelector('#medium-menu-content #active-font-name');
        this.activeThemeEl.textContent = '';
    ...
    activateFont(fontName) {
        ...
        (0, _fontModelJs.fontsModel).applyAndSaveFont(this.fontName);
        this.activateIndicator(this.fontName);
        this.updateActiveTheme(fontName);
    }
}
const fontsMediumActionsObj = new FontsMediumActions();

},{"../menuView.js":"fwEsz","./fontsMobileView.js":"bE6AW","../../models/ui/fontModel.js":"jegq2","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"bE6AW":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fontActionsObj", ()=>fontActionsObj);
var _menuViewJs = require("../menuView.js");
var _fontModelJs = require("../../models/ui/fontModel.js");
class FontsActions {
    constructor(){
    ...
    renderFonts() {
        ...
        // Build all font blocks into markup
        const fontOptionsMarkup = fontMarkupData.map((fontObj)=>this.generateFontMarkup(fontObj)).join('');
        const { fontsContentArea } = _menuViewJs.menuElements.mobileSettings;
        this.fontsContentArea = fontsContentArea; // parentEl
        // Inject into the container
        this.fontsContentArea.querySelector('#font-options-container').innerHTML = fontOptionsMarkup;
    }
    clearIndicatorEls() {
        const { fontsContentArea } = _menuViewJs.menuElements.mobileSettings;
        const btnWrapperEls = fontsContentArea.querySelectorAll('.highlight-wrapper');
        btnWrapperEls.forEach((btnWrapperEl)=>btnWrapperEl.innerHTML = '');
    }
    activateIndicator(fontName) {
        document.getElementById(`${fontName}-highlight-wrapper`).innerHTML = this.activeIndicatorTemplate();
    ...
    showActiveFont() {
        this.activeFontEl = document.querySelector('#mobile-settings-content #active-font-name');
...
const fontActionsObj = new FontsActions();

},{"../menuView.js":"fwEsz","../../models/ui/fontModel.js":"jegq2","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"jegq2":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fontsModel", ()=>fontsModel);
class FontsModel {
    constructor(){
        this.bodyEl = document.querySelector('body'); // Apply font here
        this.storageKey = 'appFont';
    ...
    applyAndSaveFont(fontName) {
        ...
        this.bodyEl.classList.remove('font-inter', 'font-rubik', 'font-spaceGrotesk', 'font-spectral', 'font-tagesschrift');
        // Apply new font
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"fi18D":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "closeAllAsides", ()=>closeAllAsides);
parcelHelpers.export(exports, "hideAllSections", ()=>hideAllSections);
parcelHelpers.export(exports, "showSection", ()=>showSection);
parcelHelpers.export(exports, "setText", ()=>setText);
parcelHelpers.export(exports, "showAndHideRest", ()=>showAndHideRest);
...
function showSection(section, ...hideSections) {
...
function showAndHideRest(section, ...hideSections) {
    section.classList.remove("hidden");
    hideSections.forEach((sec)=>sec.classList.add("hidden"));
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"8Qnew":[function(require,module,exports,__globalThis) {
...
function subscribe(eventName, callback) {
    if (!events[eventName]) events[eventName] = []; // create array for new eventName if !eventName
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"b5nUx":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "navViewObj", ()=>navViewObj);
var _themeManagerJs = require("../models/ui/themeManager.js");
var _fontModelJs = require("../models/ui/fontModel.js");
class NavView {
    constructor(){
        this.bodyEl = document.querySelector('.body');
        this.themeManagerObj = new (0, _themeManagerJs.ThemeManager)();
    ...
    closePreviousDropdowns(currentDropdownEl) {
        ...
        this.dropdownContentEls.forEach((dropdownContentEl)=>{
            if (dropdownContentEl !== currentDropdownEl) this.hideDropdown(dropdownContentEl);
        });
    }
    /**
   ...
   */ toggleDropdown(dropdownEl) {
        ...
        if (dropdownEl.classList.contains('opacity-0')) this.showDropdown(dropdownEl);
        else this.hideDropdown(dropdownEl);
    }
    /** Helper: show dropdown */ showDropdown(el) {
        el.classList.remove('opacity-0', 'pointer-events-none');
        el.classList.add('opacity-100', 'pointer-events-auto');
    }
    /** Helper: hide dropdown */ hideDropdown(el) {
    ...
    toggleSettingsDropdown() {
        ...
        this.activeFontNameEl.innerHTML = (0, _fontModelJs.fontsModel).getFont();
        this.toggleDropdown(this.settingsBtnEl);
    }
    closeAllAccordion() {
        const dropdownContentEls = document.querySelectorAll('#nav-settings-dropdown .accordion-content');
    ...
    handleAppReset() {
        [
            ...
            if (btnEl && btnEl.classList.contains('opacity-100')) this.hideDropdown(btnEl);
        });
    }
}
const navViewObj = new NavView();

},{"../models/ui/themeManager.js":"gw0Lo","../models/ui/fontModel.js":"jegq2","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"es57R":[function(require,module,exports,__globalThis) {
...
var _modeThemeMobileViewJs = require("../../views/menuDevices/modeThemeMobileView.js");
var _fontsMobileViewJs = require("../../views/menuDevices/fontsMobileView.js");
var _menuViewJs = require("../../views/menuView.js");
var _greetingViewJs = require("../../views/components/homeComponents/greetingView.js");
class MobileMenuController {
    ...
    _handleMenuActions({ action, device }) {
        if (action === 'return-home' && device === 'mobile') {
            _menuViewJs.menuActionsObj.hideMobileMenu();
            setTimeout(()=>_menuViewJs.menuActionsObj.hideSocialWrapper(device), 500);
        }
        if (action === 'card-right-arrow' && device === 'mobile') _menuViewJs.menuActionsObj.renderSocials(device);
        if (action === 'mobile-settings' && device === 'mobile') {
            _menuViewJs.menuActionsObj.renderSettings(device);
            setTimeout(()=>_menuViewJs.menuActionsObj.hideSocialWrapper(device), 500);
        }
    }
    // --- Settings Actions ---
    async _handleSettingsActions({ action }) {
        if (action === 'return-to-menu') (0, _settingsViewJs.settingsActionsObj).backToMenu();
        if (action === 'mode-theme') {
            (0, _settingsViewJs.settingsActionsObj).toggleModeThemeState();
            (0, _modeThemeMobileViewJs.modeAndThemeObj).renderModeTemplate();
            (0, _modeThemeMobileViewJs.modeAndThemeObj).restoreHighlight();
        }
        if (action === 'show-font-pannel') {
            (0, _settingsViewJs.settingsActionsObj).toggleFontState();
            (0, _fontsMobileViewJs.fontActionsObj).renderFonts();
        }
        if (action === 'logout') {
            await (0, _authModelJs.logoutUser)();
            (0, _greetingViewJs.greetingObj).clearName();
        }
    }
    // --- Mode & Theme ---
    _handleModeAndThemeActions({ action, mode }) {
        if (action === 'return-to-settings') {
            (0, _settingsViewJs.settingsActionsObj).toggleModeThemeState();
            (0, _modeThemeMobileViewJs.modeAndThemeObj).showActiveTheme();
        }
        if (action === 'system-mode') (0, _modeThemeMobileViewJs.modeAndThemeObj).toggleSystem(mode);
        if (action === 'light-mode') (0, _modeThemeMobileViewJs.modeAndThemeObj).toggleLight(mode);
        if (action === 'dark-mode') (0, _modeThemeMobileViewJs.modeAndThemeObj).toggleDark(mode);
        if (action === 'default-mode') (0, _modeThemeMobileViewJs.modeAndThemeObj).toggleDefault(mode);
    }
    // --- Fonts ---
    _handleFontActions({ action }) {
        if (action === 'return-to-settings') {
            (0, _settingsViewJs.settingsActionsObj).toggleFontState();
            (0, _fontsMobileViewJs.fontActionsObj).showActiveFont();
        }
        if (action === 'activate-font-1') (0, _fontsMobileViewJs.fontActionsObj).activateFont('inter');
        if (action === 'activate-font-2') (0, _fontsMobileViewJs.fontActionsObj).activateFont('rubik');
        if (action === 'activate-font-3') (0, _fontsMobileViewJs.fontActionsObj).activateFont('spaceGrotesk');
        if (action === 'activate-font-4') (0, _fontsMobileViewJs.fontActionsObj).activateFont('spectral');
        if (action === 'activate-font-5') (0, _fontsMobileViewJs.fontActionsObj).activateFont('tagesschrift');
    }
    // --- Subscriptions Setup ---
    _setupSubscriptions() {
        (0, _pubsubJs.subscribe)('menu:mobile:action', this._handleMenuActions.bind(this));
        (0, _pubsubJs.subscribe)('settings:mobile:action', this._handleSettingsActions.bind(this));
        (0, _pubsubJs.subscribe)('settings:modeAndTheme:action', this._handleModeAndThemeActions.bind(this));
        (0, _pubsubJs.subscribe)('settings:fonts:action', this._handleFontActions.bind(this));
    }
}
exports.default = MobileMenuController;

},{"../../helpers/pubsub.js":"8Qnew","../../models/auth/authModel.js":"9UXRz","../../views/settingsView.js":"96FwI","../../views/menuDevices/modeThemeMobileView.js":"5dwbf","../../views/menuDevices/fontsMobileView.js":"bE6AW","../../views/menuView.js":"fwEsz","../../views/components/homeComponents/greetingView.js":"1VFd2","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"96FwI":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "SettingsActions", ()=>SettingsActions);
parcelHelpers.export(exports, "settingsActionsObj", ()=>settingsActionsObj);
var _menuViewJs = require("./menuView.js");
var _templateHelperJs = require("../helpers/templateHelper.js");
class SettingsActions {
    backToMenu() {
        const { aside, contentArea } = _menuViewJs.menuElements.mobileSettings;
    ...
    toggleModeThemeState() {
        const { modeThemeContentArea } = _menuViewJs.menuElements.mobileSettings;
        this.modeThemeContentArea = modeThemeContentArea;
        this.modeThemeContentArea.classList.toggle('translate-x-full');
        if (!this.modeThemeContentArea.hasChildNodes()) (0, _templateHelperJs.renderTemplate)(this.modeThemeContentArea, _menuViewJs.templates.modeAndThemeTemplate);
    }
    toggleFontState() {
        const { fontsContentArea } = _menuViewJs.menuElements.mobileSettings;
        this.fontsContentArea = fontsContentArea;
        this.fontsContentArea.classList.toggle('translate-x-full');
        if (!this.fontsContentArea.hasChildNodes()) (0, _templateHelperJs.renderTemplate)(this.fontsContentArea, _menuViewJs.templates.fontsTemplate);
    }
}
const settingsActionsObj = new SettingsActions();

},{"./menuView.js":"fwEsz","../helpers/templateHelper.js":"l9P0L","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"5dwbf":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "modeAndThemeObj", ()=>modeAndThemeObj);
var _menuViewJs = require("../menuView.js");
var _themeManagerJs = require("../../models/ui/themeManager.js");
class ModeAndTheme {
    constructor(){
        this.modeThemeContentArea = _menuViewJs.menuElements.mobileSettings.modeThemeContentArea;
        this.themeManagerObj = new (0, _themeManagerJs.ThemeManager)();
    ...
    renderModeTemplate() {
        this.wrapperEl = this.modeThemeContentArea.querySelector('#mode-theme-parentEl');
        if (!this.wrapperEl) return;
        // Inject only once
        if (!this.wrapperEl.hasChildNodes()) this.wrapperEl.innerHTML = this.getTemplate();
    }
    selectModeElements() {
        ...
        this.systemModeEl = this.modeThemeContentArea.querySelector('[data-mode="system"]');
        this.lightModeEl = this.modeThemeContentArea.querySelector('[data-mode="light"]');
        this.darkModeEl = this.modeThemeContentArea.querySelector('[data-mode="dark"]');
        this.defaultModeEl = this.modeThemeContentArea.querySelector('[data-mode="default"]');
    }
    clearBorders() {
    ...
    showActiveTheme() {
        this.activeThemeEl = document.querySelector('#mobile-settings-content #active-theme-name');
        const currentThemeInUse = localStorage.getItem('theme');
        this.activeThemeEl.textContent = '';
        this.activeThemeEl.textContent = currentThemeInUse;
    }
}
const modeAndThemeObj = new ModeAndTheme();

},{"../menuView.js":"fwEsz","../../models/ui/themeManager.js":"gw0Lo","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"1VFd2":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "greetingObj", ()=>greetingObj);
class Greeting {
    constructor(){
...
const greetingObj = new Greeting();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"bXCZQ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _pubsubJs = require("../../helpers/pubsub.js");
var _modeThemeMediumViewJs = require("../../views/menuDevices/modeThemeMediumView.js");
...
class MediumMenuController {
    ...
    _handleMediumMenuActions({ action, device, mode }) {
        ...
        const actionMapObj = {
            ...
            'mode-theme': ()=>{
                (0, _modeThemeMediumViewJs.modeAndThemeMediumViewObj).renderHTML(device);
                (0, _modeThemeMediumViewJs.modeAndThemeMediumViewObj).toggleModeAccordion(device);
            },
            'show-font-pannel': ()=>{
                (0, _fontsMediumViewJs.fontsMediumActionsObj).renderHTML(device);
                (0, _fontsMediumViewJs.fontsMediumActionsObj).toggleFontsAccordion();
            },
            // Accordion content buttons
            'system-mode': ()=>(0, _modeThemeMediumViewJs.modeAndThemeMediumViewObj).toggleSystem(mode),
            'light-mode': ()=>(0, _modeThemeMediumViewJs.modeAndThemeMediumViewObj).toggleLight(mode),
            'dark-mode': ()=>(0, _modeThemeMediumViewJs.modeAndThemeMediumViewObj).toggleDark(mode),
            'default-mode': ()=>(0, _modeThemeMediumViewJs.modeAndThemeMediumViewObj).toggleDefault(mode),
            // Fonts
            'activate-font-1': ()=>(0, _fontsMediumViewJs.fontsMediumActionsObj).activateFont('inter'),
            'activate-font-2': ()=>(0, _fontsMediumViewJs.fontsMediumActionsObj).activateFont('rubik'),
            'activate-font-3': ()=>(0, _fontsMediumViewJs.fontsMediumActionsObj).activateFont('spaceGrotesk'),
            'activate-font-4': ()=>(0, _fontsMediumViewJs.fontsMediumActionsObj).activateFont('spectral'),
            'activate-font-5': ()=>(0, _fontsMediumViewJs.fontsMediumActionsObj).activateFont('tagesschrift'),
            // Logout
            logout: async ()=>{
                await (0, _authModelJs.logoutUser)();
                (0, _greetingViewJs.greetingObj).clearName();
        ...
        if (actionMapObj[action]) actionMapObj[action]();
    }
    _setupSubscriptions() {
        (0, _pubsubJs.subscribe)('menu:medium:action', this._handleMediumMenuActions.bind(this));
    }
}
exports.default = MediumMenuController;

},{"../../helpers/pubsub.js":"8Qnew","../../views/menuDevices/modeThemeMediumView.js":"jNDze","../../views/menuDevices/fontsMediumView.js":"jUbWb","../../models/auth/authModel.js":"9UXRz","../../views/components/homeComponents/greetingView.js":"1VFd2","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"bxbaK":[function(require,module,exports,__globalThis) {
// controllers/menu/largeMenuController.js
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _pubsubJs = require("../../helpers/pubsub.js");
var _navViewJs = require("../../views/navView.js");
var _modeThemeLargeJs = require("../../views/menuDevices/modeThemeLarge.js");
var _fontsLargeJs = require("../../views/menuDevices/fontsLarge.js");
var _authModelJs = require("../../models/auth/authModel.js");
var _greetingViewJs = require("../../views/components/homeComponents/greetingView.js");
class LargeMenuController {
    ...
    _handleActions = async ({ action, device, mode })=>{
        const actionMap = {
            ...
            'profile-dropdown': ()=>{
                (0, _navViewJs.navViewObj).toggleProfileDropdown();
                (0, _navViewJs.navViewObj).closeAllAccordion();
            },
            'settings-dropdown': ()=>{
                (0, _navViewJs.navViewObj).toggleSettingsDropdown();
            },
            'mode-theme': ()=>{
                (0, _modeThemeLargeJs.modeThemeLargeObj).renderHTML(device);
                (0, _modeThemeLargeJs.modeThemeLargeObj).toggleModeAccordion();
            },
            'system-mode': ()=>(0, _modeThemeLargeJs.modeThemeLargeObj).toggleSystem(mode),
            'light-mode': ()=>(0, _modeThemeLargeJs.modeThemeLargeObj).toggleLight(mode),
            'dark-mode': ()=>(0, _modeThemeLargeJs.modeThemeLargeObj).toggleDark(mode),
            'default-mode': ()=>(0, _modeThemeLargeJs.modeThemeLargeObj).toggleDefault(mode),
            'show-font-pannel': ()=>{
                (0, _fontsLargeJs.fontsLargeObj).renderHTML(device);
                (0, _fontsLargeJs.fontsLargeObj).toggleFontsAccordion(device);
            },
            'activate-font-1': ()=>(0, _fontsLargeJs.fontsLargeObj).activateFont('inter'),
            'activate-font-2': ()=>(0, _fontsLargeJs.fontsLargeObj).activateFont('rubik'),
            'activate-font-3': ()=>(0, _fontsLargeJs.fontsLargeObj).activateFont('spaceGrotesk'),
            'activate-font-4': ()=>(0, _fontsLargeJs.fontsLargeObj).activateFont('spectral'),
            'activate-font-5': ()=>(0, _fontsLargeJs.fontsLargeObj).activateFont('tagesschrift')
        };
    ...
    _registerSubscriptions() {
        (0, _pubsubJs.subscribe)('nav:menu::action', this._handleActions);
    }
}
exports.default = LargeMenuController;

},{"../../helpers/pubsub.js":"8Qnew","../../views/navView.js":"b5nUx","../../views/menuDevices/modeThemeLarge.js":"iOaep","../../views/menuDevices/fontsLarge.js":"3ySEx","../../models/auth/authModel.js":"9UXRz","../../views/components/homeComponents/greetingView.js":"1VFd2","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"iOaep":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "modeThemeLargeObj", ()=>modeThemeLargeObj);
var _themeManagerJs = require("../../models/ui/themeManager.js");
class ModeThemeLarge {
    ...
    // Injects accordion items only once
    renderHTML(device) {
        this.containerEl = document.querySelector(`#dashboard-section[data-screen="${device}"]  #menu-accordion-container`);
        if (!this.containerEl) return;
        if (!this.containerEl.hasChildNodes()) this.containerEl.innerHTML = this.getHTML();
    }
    toggleModeAccordion() {
...
const modeThemeLargeObj = new ModeThemeLarge();

},{"../../models/ui/themeManager.js":"gw0Lo","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"3ySEx":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fontsLargeObj", ()=>fontsLargeObj);
var _menuViewJs = require("../menuView.js");
var _fontsMobileViewJs = require("./fontsMobileView.js");
var _fontModelJs = require("../../models/ui/fontModel.js");
class FontsMediumActions {
    ...
    renderHTML(device) {
        this.contentArea = document.querySelector(`#dashboard-section[data-screen="${device}"] #medium-menu-font-accordion-container`);
        if (!this.contentArea.hasChildNodes()) this.contentArea.innerHTML = this.getHTML();
    }
...
const fontsLargeObj = new FontsMediumActions();

},{"../menuView.js":"fwEsz","./fontsMobileView.js":"bE6AW","../../models/ui/fontModel.js":"jegq2","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"ldxVE":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "mainMenuObj", ()=>mainMenuObj);
parcelHelpers.export(exports, "settingsMenuObj", ()=>settingsMenuObj);
parcelHelpers.export(exports, "modeAndThemeMenuObj", ()=>modeAndThemeMenuObj);
parcelHelpers.export(exports, "fontsMenuObj", ()=>fontsMenuObj);
parcelHelpers.export(exports, "mediumMenuObj", ()=>mediumMenuObj);
parcelHelpers.export(exports, "navMenuObj", ()=>navMenuObj);
var _pubsubJs = require("../../helpers/pubsub.js");
class Menu {
    ...
    addHandlerClick() {
        this._parentEl.addEventListener('click', (e)=>{
            ...
            (0, _pubsubJs.publish)(this._channel, {
                action,
                device: screen,
                mode: theme
            });
...
const mainMenuObj = new Menu('#mobile-menu-content', 'menu:mobile:action');
const settingsMenuObj = new Menu('#mobile-settings-content', 'settings:mobile:action');
const modeAndThemeMenuObj = new Menu('#mode-theme-panel', 'settings:modeAndTheme:action');
const fontsMenuObj = new Menu('#fonts-panel', 'settings:fonts:action');
const mediumMenuObj = new Menu('#medium-menu-content', 'menu:medium:action');
const navMenuObj = new Menu('#dashboard-section', 'nav:menu::action');

},{"../../helpers/pubsub.js":"8Qnew","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"dAtzM":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "greetingControllerObj", ()=>greetingControllerObj);
var _greetingViewJs = require("../../views/components/homeComponents/greetingView.js");
var _authModelJs = require("../../models/auth/authModel.js");
var _getGreetingJs = require("../../models/dateTime/getGreeting.js");
class GreetingController {
    constructor(){}
    initGreetingUi() {
        const greetingText = (0, _getGreetingJs.greetingModelObj).greetingMessage();
        const cachedName = localStorage.getItem('username');
        // Show cached name immediately to avoid delay
        (0, _greetingViewJs.greetingObj).renderGreeting(cachedName, greetingText);
        // Observe Firebase user state
        (0, _authModelJs.observeUser)((userObj)=>{
            if (!userObj) return; // Ignore the first null emission
            const userName = userObj.displayName || cachedName;
            (0, _greetingViewJs.greetingObj).renderGreeting(userName, greetingText);
            // Clear cache once Firebase confirms the user
            if (userObj.displayName) localStorage.removeItem('username');
        });
    }
}
const greetingControllerObj = new GreetingController();

},{"../../views/components/homeComponents/greetingView.js":"1VFd2","../../models/auth/authModel.js":"9UXRz","../../models/dateTime/getGreeting.js":"iE2ba","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"iE2ba":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "greetingModelObj", ()=>greetingModelObj);
class GreetingModel {
    greetingMessage() {
...
const greetingModelObj = new GreetingModel();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"3PeSj":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"8oAPi":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "loadSVGSprite", ()=>loadSVGSprite);
var _configJs = require("../../config/config.js");
async function loadSVGSprite() {
    try {
        const response = await fetch((0, _configJs.SVG_PATH));
        if (!response.ok) throw new Error(`Failed to fetch ${(0, _configJs.SVG_PATH)}: ${response.status}`);
...
},{"../../config/config.js":"4nMmN","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"4nMmN":[function(require,module,exports,__globalThis) {
// const isVercel = window.location.hostname.includes('vercel.app');
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "SVG_PATH", ()=>SVG_PATH);
const SVG_PATH = '../assets/icons.svg';

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"5AgXN":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _authModelJs = require("../../models/auth/authModel.js");
var _greetingControllerJs = require("../home/greetingController.js");
...
const sessionController = {
    init () {
        ...
        loaderEl.classList.remove('hidden');
        (0, _authModelJs.observeUser)((user)=>{
            loaderEl.classList.add('hidden');
            if (user) {
                // User logged in — update greeting and show dashboard
                const userName = user.displayName || localStorage.getItem('username');
                (0, _greetingControllerJs.greetingControllerObj).initGreetingUi(userName);
                (0, _viewManagerJs.viewManager).hideAndShowRest('auth-section', 'dashboard-section', 'dashboard-header', 'market-section');
            } else // User logged out — show auth screen, hide others
            (0, _viewManagerJs.viewManager).showndHideRest('auth-section', 'dashboard-section', 'dashboard-header', 'market-section');
        });
    }
};
exports.default = sessionController;

},{"../../models/auth/authModel.js":"9UXRz","../home/greetingController.js":"dAtzM","../viewManager/viewManager.js":"3PeSj","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"kaXqB":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "portfolioController", ()=>portfolioController);
var _portfolioSummaryViewJs = require("../../views/components/homeComponents/portfolio/portfolioSummaryView.js");
var _portfolioPnLViewJs = require("../../views/components/homeComponents/portfolio/portfolioPnLView.js");
class PortfolioController {
    constructor(){}
    initPortfolioSummary() {
        (0, _portfolioSummaryViewJs.portfolioSummary).renderPortfolioSummary();
        (0, _portfolioPnLViewJs.portfolioPnLView).renderPNL();
    }
}
const portfolioController = new PortfolioController();

},{"../../views/components/homeComponents/portfolio/portfolioSummaryView.js":"bX642","../../views/components/homeComponents/portfolio/portfolioPnLView.js":"9x8Kx","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"bX642":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "portfolioSummary", ()=>portfolioSummary);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"9x8Kx":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "portfolioPnLView", ()=>portfolioPnLView);
...
const portfolioPnLView = new PortfolioPnLView();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"3NpTX":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class MarketModel {
    #socket = null;
  ...
  ============================================================ */ async #fetchAllPages(pages = 4, perPage = 250) {
        ...
        for(let i = 1; i <= pages; i++){
            const url = `${this.#baseUrl}/coins/markets?vs_currency=${this.#currency}&order=market_cap_desc&per_page=${perPage}&page=${i}`;
  ...
  ============================================================ */ async #filterBinanceCoins(coins) {
        ...
        return coins.filter((coinObj)=>binanceSymbols.has(`${coinObj.symbol.toUpperCase()}USDT`));
    }
    /* ============================================================
     FETCH TOP COINS BY MARKET CAP
  ============================================================ */ async fetchTopCoins(limit = 10) {
        const data = await this.#safeFetch(`${this.#baseUrl}/coins/markets?vs_currency=${this.#currency}&order=market_cap_desc&per_page=${limit}&page=1`, 'Failed to fetch top coins');
  ...
  ============================================================ */ async fetchGainers(limit = 10) {
        ...
        const filtered = allCoins.filter((coinObj)=>this.#isValidCoin(coinObj)).map(this.#formatCoinData);
  ...
  ============================================================ */ async fetchTrending(limit = 5) {
        ...
        const filtered = data.filter((coinObj)=>this.#isValidCoin(coinObj) && coinObj.market_cap > 5000000 && coinObj.total_volume > 1000000).map(this.#formatCoinData);
        const binanceCoins = await this.#filterBinanceCoins(filtered);
        const sorted = binanceCoins.sort((a, b)=>b.total_volume / b.market_cap - a.total_volume / a.market_cap).slice(0, limit);
  ...
  ============================================================ */ #isValidCoin(coinObj) {
        ...
        if (!coinObj || !coinObj.symbol || isNaN(pct) || coinObj.current_price <= 0 || coinObj.market_cap < 500000 || /usd|usdt|usdc|dai|busd|tusd|fdusd/i.test(coinObj.symbol)) return false;
        return true;
    }
    /* ============================================================
  ...
  ============================================================ */ async startLiveUpdates(coinList = this.#topCoins) {
        ...
        if (!Array.isArray(coinList) || coinList.length === 0) return;
        const binanceSymbols = await this.#getBinanceSymbols();
        const validPairs = coinList.map((coinObj)=>`${coinObj.symbol.toUpperCase()}USDT`).filter((pair)=>binanceSymbols.has(pair)).map((pair)=>pair.toLowerCase());
        if (!validPairs.length) return;
        const url = `wss://stream.binance.com:9443/stream?streams=${validPairs.map((p)=>`${p}@ticker`).join('/')}`;
        this.#socket = new WebSocket(url);
        this.#socket.onmessage = (e)=>this.#handleMessage(e);
        this.#socket.onclose = ()=>{
            this.#reconnectTimer = setTimeout(()=>this.startLiveUpdates(coinList), 6000);
        };
    }
    /* ============================================================
     HANDLE LIVE MESSAGE
  ...
  ============================================================ */ subscribe(updateCoinPriceFn) {
        if (typeof updateCoinPriceFn === 'function') this.#priceUpdateSubscribers.push(updateCoinPriceFn);
        return ()=>{
            this.#priceUpdateSubscribers = this.#priceUpdateSubscribers.filter((storedFn)=>storedFn !== updateCoinPriceFn);
        };
    }
  ...
  ============================================================ */ #formatCoinData(coinObj) {
        return {
            ...
            name: coinObj.name,
            image: coinObj.image || 'https://assets.coingecko.com/coins/images/1/large/bitcoin.png',
            current_price: parseFloat(coinObj.current_price) || 0,
            price_change_percentage_24h: parseFloat(coinObj.price_change_percentage_24h) || 0,
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"6CZOb":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "marketController", ()=>marketController);
var _marketModelJs = require("../../../models/market/marketModel.js");
var _marketModelJsDefault = parcelHelpers.interopDefault(_marketModelJs);
var _marketIntroViewJs = require("../../../views/components/homeComponents/marketIntroView.js");
var _marketViewJs = require("../../../views/components/homeComponents/marketView.js");
class MarketController {
    constructor(){
        this.model = new (0, _marketModelJsDefault.default)();
  ...
  ============================================================ */ async init() {
        ...
        (0, _marketIntroViewJs.marketIntroView).renderMarkup();
        (0, _marketViewJs.marketView).renderMarketTab();
  ...
  ============================================================ */ async loadTabData(tabName, value, id) {
        ...
        (0, _marketViewJs.marketView).renderLoadingSkeleton(value, id);
        let data = [];
        switch(tabName){
            case 'favorites':
        ...
        (0, _marketViewJs.marketView).renderAsset(data, id);
        ...
        this._liveUnsubscribe = this.model.subscribe((coinUpdate)=>{
            ...
            (0, _marketViewJs.marketView).updateCoinPrice({
                ...coinUpdate,
                containerId: id
            });
        });
...
},{"../../../models/market/marketModel.js":"3NpTX","../../../views/components/homeComponents/marketIntroView.js":"cewPn","../../../views/components/homeComponents/marketView.js":"fcJww","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"cewPn":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "marketIntroView", ()=>marketIntroView);
    ...
    markup() {
      ...
      <div class="flex flex-col md:space-y-0.5 lg:space-y-4">
        ...
        <p class="text-sm text-textBase-darkGray">
          Stay on top of your holdings without moving your fund \u{2014} smarter
...
const marketIntroView = new MarketIntroView();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"fcJww":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "marketView", ()=>marketView);
var _pubsubJs = require("../../../helpers/pubsub.js");
class MarketView {
    constructor(){
  ...
  ============================ */ tabMarkup({ tab, label }) {
    ...
    renderMarketTab(id = 'market-tabs') {
        ...
        if (firstMatch) {
            firstMatch.classList.remove('text-black', 'text-white', 'font-medium', 'font-bold');
            document.documentElement.classList.contains('light') ? firstMatch.classList.add(...this.lightClasses) : firstMatch.classList.add(...this.darkClasses);
  ...
  ============================ */ observeThemeChange(parentEl) {
        ...
        const observer = new MutationObserver(()=>{
            ...
            tabEls.forEach((tabEl)=>tabEl.classList.remove('text-white', 'text-black', 'font-bold', 'font-medium'));
            if (!this.selectedTabEl) return;
            observedEl.classList.contains('light') ? this.selectedTabEl.classList.add(...this.lightClasses) : this.selectedTabEl.classList.add(...this.darkClasses);
        });
  ...
  ============================ */ handleTabClick(loadDataCB, id = 'market-tabs') {
        ...
        parentEl.addEventListener('click', (e)=>{
            ...
            const tabEls = parentEl.querySelectorAll('.tab-item');
            tabEls.forEach((tabEl)=>tabEl.classList.remove('text-white', 'text-black', 'font-bold', 'font-medium'));
            document.documentElement.classList.contains('light') ? btn.classList.add(...this.lightClasses) : btn.classList.add(...this.darkClasses);
  ...
  ============================ */ loadingSkelentonMarkup() {
    ...
    renderLoadingSkeleton(value, id = 'market-list-container') {
        ...
        parentEl.innerHTML = items.map((_, i)=>this.loadingSkelentonMarkup()).join('');
    }
    /* ============================
     MARKET ROW RENDERING
  ============================ */ assetMarkup({ name, symbol, image, current_price, price_change_percentage_24h }) {
    ...
    formatPrice(current_price) {
        if (current_price >= 1000) return current_price.toLocaleString(undefined, {
    ...
    /* ============================
     LIVE PRICE UPDATES
  ============================ */ updateCoinPrice({ symbol, price, change, containerId = 'market-list-container' }) {
        const now = Date.now();
        const lastUpdate = this.lastUpdateTimes[symbol] || 0;
        if (now - lastUpdate < 1000) return;
        this.lastUpdateTimes[symbol] = now;
        const row = document.getElementById(containerId).querySelector(`[data-symbol="${symbol}"]`);
        if (!row) return;
        ...
        changeEl.textContent = `${safeChange >= 0 ? '+' : ''}${safeChange.toFixed(2)}%`;
  ...
  ============================ */ viewMoreClickHandler() {
        ...
        parentEl.addEventListener('click', (e)=>{
            ...
            (0, _pubsubJs.publish)('market:view-more', {
                action
            });
        });
    }
    renderViewMorePanel(loadDataCB) {
        ...
        if (panelEl.classList.contains('translate-x-full')) panelEl.classList.toggle('translate-x-full');
    }
    renderHome() {
        const parentEl = this.marketSectionEl;
        const panelEl = parentEl.querySelector('#view-more-panel');
...
},{"../../../helpers/pubsub.js":"8Qnew","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"eXOdo":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "viewMoreController", ()=>viewMoreController);
var _marketModelJs = require("../../../models/market/marketModel.js");
var _marketModelJsDefault = parcelHelpers.interopDefault(_marketModelJs);
var _marketViewJs = require("../../../views/components/homeComponents/marketView.js");
var _pubsubJs = require("../../../helpers/pubsub.js");
var _marketControllerJs = require("./marketController.js");
...
const viewMoreController = new ViewMoreController();

},{"../../../models/market/marketModel.js":"3NpTX","../../../views/components/homeComponents/marketView.js":"fcJww","../../../helpers/pubsub.js":"8Qnew","./marketController.js":"6CZOb","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"9hkbW":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addHoldings", ()=>addHoldings);
var _templateHelperJs = require("../../../helpers/templateHelper.js");
var _pubsubJs = require("../../../helpers/pubsub.js");
var _homePublisherJs = require("../../publisher/homePublisher.js");
var _addHoldingsViewJs = require("../../../views/components/homeComponents/addHoldingsView.js");
class AddHoldings {
    constructor(){
        // Helper: safe getElementById. call by running $(id)
    ...
    injectTemplatetoPanel() {
        ...
        if (!targetContainer.hasChildNodes()) {
            if (templateEl) (0, _templateHelperJs.renderTemplate)(targetContainer, templateEl);
        }
    }
    _handleAction({ action }) {
        if (action === 'show-add-holdings') {
            console.log('im here');
            (0, _addHoldingsViewJs.holdingsPanelView).toggleVisibility();
        }
        if (action === 'close-holdings-panel') (0, _addHoldingsViewJs.holdingsPanelView).toggleVisibility();
    }
    init() {
        (0, _homePublisherJs.homePublisher).addHandlerClick();
        (0, _pubsubJs.subscribe)('home:btn-clicked', this._handleAction.bind(this));
    }
}
const addHoldings = new AddHoldings();

},{"../../../helpers/templateHelper.js":"l9P0L","../../../helpers/pubsub.js":"8Qnew","../../publisher/homePublisher.js":"hJgdy","../../../views/components/homeComponents/addHoldingsView.js":"6ShZN","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"hJgdy":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "homePublisher", ()=>homePublisher);
var _pubsubJs = require("../../helpers/pubsub.js");
class HomePublisher {
    constructor(parentSelector, channel){
        this._parentEl = document.querySelector(parentSelector);
...
const homePublisher = new HomePublisher('body', 'home:btn-clicked');

},{"../../helpers/pubsub.js":"8Qnew","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"6ShZN":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "holdingsPanelView", ()=>holdingsPanelView);
...
const holdingsPanelView = new HoldingsPanelView();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["io2N8","bNJxx"], "bNJxx", "parcelRequiref879", {})

//# sourceMappingURL=cryptoSpy_mod.36960861.js.map
